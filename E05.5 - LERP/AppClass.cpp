...
void Application::Display(void)
{
	...
	//your code goes here
	v3CurrentPos += glm::lerp(m_stopsList[count],m_stopsList[count+1], v3CurrentPos)*fTimer/2;
	if (glm::lerp(m_stopsList[count], m_stopsList[count + 1], v3CurrentPos).length()*((count+1)/ (fTimer / 2)) <1)
	{
		count++;
	}
