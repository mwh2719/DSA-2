...
void Application::ProcessKeyPressed(sf::Event a_event)
{
		...
		if(sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
		{
			...
			q2 = glm::angleAxis(glm::radians(359.9f), AXIS_Z);
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
		{
			...
			vector3 v3Temp(glm::radians(m_v3Rotation.x), glm::radians(m_v3Rotation.y), glm::radians(m_v3Rotation.z));
			m_qOrientation = quaternion(vector3(v3Temp));*/
			q2 = glm::angleAxis(glm::radians(359.9f), AXIS_Y);
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
		{
			...
			vector3 v3Temp(glm::radians(m_v3Rotation.x), glm::radians(m_v3Rotation.y), glm::radians(m_v3Rotation.z));
			m_qOrientation = quaternion(vector3(v3Temp));*/
			q2 = glm::angleAxis(glm::radians(359.9f), AXIS_X);
		}
...
void Application::ProcessKeyReleased(sf::Event a_event)
{
	...
	/*case sf::Keyboard::Z:
		...
		{
			//q1 = m_v3Rotation;
			q1 = glm::angleAxis(glm::radians(0.0f), AXIS_Z);
			q2 = glm::angleAxis(glm::radians(0.0f), AXIS_Z);
		}
		else
		{
			q1 = glm::angleAxis(glm::radians(0.0f), AXIS_Z);
	...
	case sf::Keyboard::Y:
		if (fMultiplier)
		{
			q1 = glm::angleAxis(glm::radians(0.0f), AXIS_Y);
			q2 = glm::angleAxis(glm::radians(0.0f), AXIS_Y);
		}
		else
		{
			q1 = glm::angleAxis(glm::radians(0.0f), AXIS_Y);
	...
	case sf::Keyboard::X:
		if (fMultiplier)
		{
			q1 = glm::angleAxis(glm::radians(0.0f), AXIS_X);
			q2 = glm::angleAxis(glm::radians(0.0f), AXIS_X);
		}
		else
		{
			q1 = glm::angleAxis(glm::radians(0.0f), AXIS_X);
